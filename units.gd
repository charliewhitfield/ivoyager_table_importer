...
# This node is loaded as singleton 'IVUnits'. You can replace this singleton by
# creating an override file 'res://ivoyager_override.cfg' with these lines:
#
# [table_importer_autoload]
#
# IVUnits="path_to_replacement_node"
#
#
# You can modify dictionaries 'unit_multipliers' & 'unit_lambdas'. However,
# if you need different base units or derived unit constants, we suggest you
# replace this singleton as outlined above.
